public class Linkedlist {
    ...
    public void menubaru(String editor) {
        ...
        if (isFound != null) {
            System.out.println(isFound.getData().getName() + " mengedit " + isFound.getData().getFreq()
                    + " artikel.");            
    ...
    public void searchContainsEditor(String editor){
        ...
        while(current != null){
            if(current.getData().getName().toLowerCase().contains(editor.toLowerCase())){
                System.out.println(current.getData().getName() + " ditemukan dengan " + current.getData().getFreq() + " artikel.");
            }
            if(current.getNext() == null){
                break;
            }
